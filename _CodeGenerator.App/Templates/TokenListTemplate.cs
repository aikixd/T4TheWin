...
#line hidden
        ...
        {
            this.Write("\r\nusing System;\r\nusing System.Collections.Generic;\r\nusing System.Linq;\r\nusing Mic" +
                    "rosoft.VisualStudio.Text;\r\n\r\nnamespace ");
            
            #line 12 "C:\Dev\T4TW\_CodeGenerator.App\Templates\TokenListTemplate.tt"
            ...
            #line 20 "C:\Dev\T4TW\_CodeGenerator.App\Templates\TokenListTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(this.ClassInfo.Name));
            
            #line default
            #line hidden
            this.Write(@"Tokens(IList<RawToken> tokens)
		{
			if (tokens.Count == 0)
